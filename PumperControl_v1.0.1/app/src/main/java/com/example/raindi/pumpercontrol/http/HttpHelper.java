...
import com.example.raindi.pumpercontrol.utils.IOUtils;
...
public class HttpHelper {
	...
	/** post请求，获取返回字符串内容 */
	public static HttpResult post(String url, String json) throws UnsupportedEncodingException {
		HttpPost httpPost = new HttpPost(url);
	...
	private static HttpResult execute(String url, HttpRequestBase requestBase) {
		...
		while (retry) {
			try {
				...
				System.err.println("httpClient.execute Exception:" + e.getMessage());
				e.printStackTrace();
