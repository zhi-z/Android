...
public class DatePickerPopWin extends PopupWindow implements OnClickListener {
    ...
    private static final int DEFAULT_MIN_YEAR = 00;
    ...
    private void initDayPickerView() {
        ...
        calendar.set(Calendar.HOUR, minYear + yearPos);
        calendar.set(Calendar.MINUTE, monthPos);
